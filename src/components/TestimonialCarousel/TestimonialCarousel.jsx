      ...
      <div className="px-4 mx-auto w-[1580px] sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
          ...
          <div className="relative mt-10 md:mt-24 md:order-2">
            ...
            <div className="relative grid max-w-full grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                  ...
                  <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    <div className="flex-1">
                      ...
                      <blockquote className="flex-1 mt-8">
                        <p className="text-lg leading-relaxed text-gray-900 font-pj">
                          “{review.body}” {/* Updated to use review body */}
                        </p>
                      </blockquote>
                    </div>
                    ...
                    <div className="flex items-center mt-8">
                      <img
                        ...
                        src={review.avatar || "https://i.ibb.co.com/Gk3Y0W0/3237472.png"} // Replace with appropriate field
                        alt={review.name || "Student"} // Use review name if available
                      />
                      <div className="ml-4">
                        <p className="text-base font-bold text-gray-900 font-pj">
                         {getUsernameById(review.author)} {/* Updated to use review name */}
                        </p>
                        <p className="mt-0.5 text-sm font-pj text-gray-600">
                          {review.position || "Student"} {/* Optional: Add a position field if available */}
                        </p>
                      </div>
                    </div>
                  </div>
