...
const Subjects = () => {
  ...
  useEffect(() => {
    fetch("https://school-management-dusky.vercel.app/academics/subjects/")
  ...
  return (
    <div>
      ...
      >
        <div className="py-11">
          <h1 className="text-2xl text-blue-500 text-center  m-auto">
            All Courses
          </h1>
        </div>
        <h1 className="text-5xl mb-4">Empowering Your Educational Journey</h1>
        <p className="mb-0 mx-1">
          Our institution is committed to providing a supportive and challenging
          environment that encourages students to achieve their full potential.
          Discover the features that make our school, college, or university a
          leader in education.
        </p>
      </div>
            ...
            {subjects.map((subject, index) => (
              ...
              >
                <a href="#" className="block">
                  <div className="h-28">
                    <div className="absolute -top-20 lg:top-[-10%] left-[5%] z-40 group-hover:top-[-40%] group-hover:opacity-[0.9] duration-300 w-[90%] h-48 bg-gray-100 rounded-xl justify-items-center align-middle mb-6">
